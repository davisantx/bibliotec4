...
from core.livros import (
    processar_busca_de_livro_pelo_titulo,
    processar_busca_livros_pelo_status,
    processar_criacao_do_livro,
    processar_exclusao_de_livro,
)
from core.relatorios import (
    mostrar_numero_de_livros_disponiveis_e_emprestados,
    mostrar_os_livros_recentes,
    mostrar_quais_livros_cada_autor_tem_na_biblioteca,
    mostrar_todos_os_dados_registrados_da_biblioteca,
)
from ui.coletores import (
    excluir_todos_autores_sem_livros,
    exibir_lista_com_autores_existentes,
...
def configurar_menus():
    ...
    (menu_excluir
        .add_opcao("Excluir livro por ID", acao=formulario_excluir_id.exibir)
        .add_opcao("Excluir livro pelo título", acao=formulario_excluir_titulo.exibir)
        .add_opcao("Excluir autor sem livros cadastrados", acao=menu_exclusao_de_autor.exibir)
        .add_navegacao("Voltar"))

    (menu_exclusao_de_autor
        .add_opcao("Escolher apenas um autor sem livros para excluir", acao=exibir_lista_com_autores_que_podem_ser_excluidos)
        .add_opcao("Excluir todos os autores sem livros", acao=excluir_todos_autores_sem_livros)
        .add_navegacao("Voltar")
    )
    ...
    (formulario_cadastro_livro
        ...
        .add_campo("autor", "Autor", input_personalizado=exibir_lista_com_autores_existentes)
